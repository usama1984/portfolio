    ...
    >
      ...
      >
        <h3 className="capitalize font-bold text-2xl">
          {position}&nbsp;
          <a href={companyLink} className="capitalize" target="_blank">
            @{company}
          </a>
        </h3>
    ...
    <section id="experience">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            position="Web Developer & Digital Marketing Executive"
            company="Abu Dhabi Marine"
            companyLink="www.abudhabimarine.ae"
            time="Jan 2024 - Present"
            address="Abu Dhabi, UAE"
            work="In my role as a Web Developer & Digital Marketing Executive at Abu Dhabi Marine, I have successfully integrated my web development and digital marketing skills to enhance the company’s online presence and user experience. By managing the website, optimizing content, and executing effective SEO strategies, I have significantly driven engagement and growth. My diverse responsibilities also include social media management, graphic and video design, and online advertising, all aimed at improving visibility and user interaction."
          />
